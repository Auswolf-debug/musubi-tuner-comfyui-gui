...
i2v_1_3B_FC = copy.deepcopy(i2v_1_3B)
i2v_1_3B_FC.__name__ = "Config: Wan-Fun-Control I2V 1.3B"
i2v_1_3B_FC.i2v = True  # this is strange, but Fun-Control model needs this because it has img cross-attention
i2v_1_3B_FC.in_dim = 48
i2v_1_3B_FC.is_fun_control = True
